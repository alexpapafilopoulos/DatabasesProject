...
if (isset($_POST['backup'])) {
    $command = "C:\\xampp\\mysql\\bin\\mysqldump.exe --user=root --password= --host=localhost library > C:\\xampp\\mysql\\bin\\last.sql";
...
if (isset($_POST['restore'])) {
    $command = "C:\\xampp\\mysql\\bin\\mysql.exe --user=root --password= --host=localhost library < C:\\xampp\\mysql\\bin\\last.sql";
