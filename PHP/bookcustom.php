...
<body>
    ...
    if (isset($_POST['show_reviews'])) {
        ...
        $query = "SELECT review, likert FROM rates WHERE book_id = $bookId";
    ...
    if (isset($_POST['submit_update'])) {
        ...
        $updateQuery = "UPDATE books SET title='$title', isbn='$isbn',pages='$pages',summary='$summary',book_language='$language' WHERE book_id='$bookId';";
        if (mysqli_query($connection, $updateQuery)) {
            echo "<p>Book details updated successfully!</p>";
        } else {
            echo "<p class='error-message'>Error updating book details: " . mysqli_error($connection) . "</p>";
        }
    }
    ...
    if (isset($_POST['submit'])) {
        ...
        echo "<p><strong>Title:</strong> <input type='text' name='title' value='" . $book['title'] . "'></p>";
        echo "<p><strong>ISBN:</strong> <input type='text' name='isbn' value='" . $book['isbn'] . "'></p>";
        echo "<p><strong>Pages:</strong> <input type='text' name='pages' value='" . $book['pages'] . "'></p>";
        echo "<p><strong>Summary:</strong> <input type='text' name='summary' value='" . $book['summary'] . "'></p>";
        echo "<p><strong>Language:</strong> <input type='text' name='language' value='" . $book['book_language'] . "'></p>";
